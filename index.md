---
title: "PUMA Dokumentation"
keywords: sample homepage
tags: [getting_started]
sidebar: mydoc_sidebar
permalink: index.html
summary: Hier wird ein Überblick gegeben wie PUMA als Literaturverwaltungsprogramm, zur Unibibliografie und für die Generierung von Literaturlisten eingesetzt werden kann.
---

{% include note.html content="Diese Seiten stellen keine direkte Hilfe zu PUMA dar, es soll vielmehre angezeigt werden für welche Zwecke PUMA eingesetzt wird und bietet dazu Unterstützung. Die PUMA-Hilfe findet sich unter <a alt='PUMA Hilfe' href='https://puma.ub.uni.stuttgart.de/Hilfe'>PUMA Hilfe</a>. PUMA basiert auf Bibsonomy, weitere Informationen finden sich hier <a href='https://bitbucket.org/bibsonomy/wiki/'>Bibsonomy Wiki</a>." %}

## Anmelden bei PUMA

Nur Angehörige der Universität Stuttgart können PUMA verwenden.

### 1. Erste Anmeldung bei PUMA

Über [PUMA](https://puma.ub.uni-stuttgart.de) können sie sich mit ihrem ac oder st-Konto anmelden. Bei der ersten Anmeldung müssen Sie einen Nutzername vergeben.
